    ...
    const articles: Article[] = [
        {
            ...
            content:
                'Sócrates revolucionó la filosofía griega con su método dialéctico, conocido como mayéutica. A través del diálogo y las preguntas, buscaba que sus interlocutores descubrieran por sí mismos la verdad. Su famosa frase "Conócete a ti mismo" sigue siendo un pilar fundamental del pensamiento filosófico occidental.',
            image: '💭',
